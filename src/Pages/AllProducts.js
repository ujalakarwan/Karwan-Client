...
import ProductItems from "../Components/DisplayItems/ProductItems";

const AllProducts = () => {
  const [check, setCheck] = useState(false);

  const { data: products, isloading } = useFetch("/get-products", check);
      ...
      <div className="w-[90%] max-w-5xl h-full mx-auto">
        ...
        <div className="flex flex-col px-0">
          <div className="flex items-center justify-between">
            <p className="text-lg font-bold text-secondary">Products</p>
            <svg
