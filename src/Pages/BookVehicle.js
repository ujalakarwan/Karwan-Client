...
import ProductItems from "../Components/DisplayItems/AllBookingVehicleItems";
...
const AllHotels = () => {
  ...
  const { data: products, isloading } = useFetch("/get-hotels", check);
  const date = currentDate();
  console.log("dhsj",state)
  return (
    <Card>
      <div className="w-[90%] max-w-5xl h-full mx-auto">
        <header className="flex flex-col gap-2 justify-start mb-14 ">
          <h1 className="text-4xl">All Vehicles</h1>
        ...
        <div className="flex flex-col px-0">
          <div className="flex items-center justify-between">
            <p className="text-lg font-bold text-secondary">Vehicles</p>
            <svg
