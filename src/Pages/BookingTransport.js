...
import ProductItems from "../Components/DisplayItems/AllBookingTransportsItems";
    ...
    <Card>
      <div className="w-[90%] max-w-5xl h-full mx-auto">
        <header className="flex flex-col gap-2 justify-start mb-14 ">
          <h1 className="text-4xl">All Transport Services</h1>
        ...
        <div className="flex flex-col px-0">
          <div className="flex items-center justify-between">
            <p className="text-lg font-bold text-secondary">Transport Services</p>
            <svg
