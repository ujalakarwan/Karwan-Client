    ...
    <>
      <div className="grid grid-cols-12 place-items-center text-center">
        ...
        <div className="col-span-1 lg:col-span">
          <Button
            onClick={() => {
              navigate(`/dashboard/edit-hotelbooking/${productCart._id}`);
            }}
          >
            Details
          </Button>
        ...
        <div className="col-span lg:col-span-1">
          <Button
            onClick={() => {
              navigate(`/dashboard/hotelbookingshistory/${productCart.user_id._id}`);
            }}
          >
            History
          </Button>
