      ...
      <div className="grid grid-cols-12 place-items-center text-center">
        <div className="col-span-6 lg:col-span-8 flex place-self-start text-left font-semibold text-primary">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <p className=" text-[#404852] text-[14px]">Transport Company</p>
              <p className=" text-[#404852] self-end">:</p>
              <p className="text-primary text-[16px] font-semibold opacity-70">
        ...
        <div className="col-span-1 lg:col-span">
          <Button
            onClick={() => {
              navigate(`/dashboard/edit-transportbooking/${productCart._id}`);
            }}
          >
            Details
          </Button>
        ...
        <div className="col-span lg:col-span-1">
          <Button
            onClick={() => {
              navigate(`/dashboard/transportbookingshistory/${productCart.user_id?._id}`);
            }}
          >
            History
          </Button>
